    ...
    <div class="footer-btm-bar">        
        <div class="container">    
            <div class="footer-copyright row">
                <div class="col-xs-12">
                    <p>
			&copy; <?php echo date('Y') ?> Radion | Powered by Sphereapps Inc.
			<?php //echo $themo_footer_copyright_output ;?> <?php //echo $themo_footer_spacer;?> <?php //echo $themo_footer_credit_output;?>
		    </p>
                </div>
            </div>
        </div>
